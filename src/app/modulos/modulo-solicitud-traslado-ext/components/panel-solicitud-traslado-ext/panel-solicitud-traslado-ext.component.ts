...
@Component({
  selector: 'app-panel-solicitud-traslado-ext',
  templateUrl: './panel-solicitud-traslado-ext.component.html',
  styleUrls: ['./panel-solicitud-traslado-ext.component.css']
})

export class PanelSolicitudTraslaExtComponent implements OnInit {
   // Titulo del componente
   titulo = 'Solicitud de Traslado - Externo';
  ...
  ngOnInit() {
    ...
    this.idResaltar = (this.sessionStorage.getItemDecrypt('idsolicitudtraslado-ext'))? parseInt(this.sessionStorage.getItemDecrypt('idsolicitudtraslado-ext')):0;
  ...
  onToCreate(){
    ...
    this.router.navigate(['/main/modulo-sx/solicitud-traslado-ext-crear']);
