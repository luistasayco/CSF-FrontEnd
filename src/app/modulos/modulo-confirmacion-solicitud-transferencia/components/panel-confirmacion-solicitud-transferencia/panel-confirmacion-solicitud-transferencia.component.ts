...
@Component({
  selector: 'app-panel-confirmacion-solicitud-transferencia',
  templateUrl: './panel-confirmacion-solicitud-transferencia.component.html',
  styleUrls: ['./panel-confirmacion-solicitud-transferencia.component.css']
})

export class PanelConfirmacionSolicitudTransferenciaComponent implements OnInit {
