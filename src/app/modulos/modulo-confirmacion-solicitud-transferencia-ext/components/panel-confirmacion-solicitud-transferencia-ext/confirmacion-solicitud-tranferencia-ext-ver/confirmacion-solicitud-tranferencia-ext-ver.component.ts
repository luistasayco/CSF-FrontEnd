...
@Component({
  selector: 'app-confirmacion-solicitud-tranferencia-ext-ver',
  templateUrl: './confirmacion-solicitud-tranferencia-ext-ver.component.html',
  styleUrls: ['./confirmacion-solicitud-tranferencia-ext-ver.component.scss'],
})

export class ConfirmacionSolicitudTraslaExtVerComponent implements OnInit {
  @Input() item;
