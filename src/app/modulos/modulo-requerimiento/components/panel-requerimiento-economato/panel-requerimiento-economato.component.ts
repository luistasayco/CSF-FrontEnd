...
@Component({
  selector: 'app-panel-requerimiento-economato',
  templateUrl: './panel-requerimiento-economato.component.html',
  styleUrls: ['./panel-requerimiento-economato.component.css']
})
export class PanelRequerimientoEconomatoComponent implements OnInit, OnDestroy {
  // Titulo del componente
  titulo = 'Requerimiento Economato';
  ...
  ngOnInit() {
    if (this.sessionStorage.getItem('busquedaRequerimientoEconomato')) {
        const bodyBusqueda = this.sessionStorage.getItem('busquedaRequerimientoEconomato');
  ...
  modificar() {
    ...
    this.router.navigate(['/main/modulo-re/modificar-requerimiento-economatos', idRequerimiento, origen]);
  }
  ...
  clickNuevo() {
      ...
      this.router.navigate(['/main/modulo-re/registrar-requerimiento-economatos'], {
        queryParams: {
