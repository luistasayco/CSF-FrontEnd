...
@Component({
  selector: 'app-atencion-solicitud-tranferencia-ext-articulo-ver',
  templateUrl: './atencion-solicitud-tranferencia-ext-articulo-ver.component.html',
  styleUrls: ['./atencion-solicitud-tranferencia-ext-articulo-ver.component.scss'],
})

export class AtencionSolicitudTrasladoExtArticuloVerComponent implements OnInit {
  @Input() item;
  @Input() itemAlmacen;
